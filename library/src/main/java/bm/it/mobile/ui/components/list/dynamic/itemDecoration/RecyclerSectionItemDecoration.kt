package bm.it.mobile.ui.components.list.dynamic.itemDecoration
...
abstract class RecyclerSectionItemDecoration(@NonNull private val mListener: SectionCallback) :
